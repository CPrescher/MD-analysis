...
create_df_stack_plot(sq_series_df, os.path.join(output_folder, "sq_series_stack.png"), skip=2)
create_df_stack_plot(rdf_series_df, os.path.join(output_folder, "rdf_series_stack.png"), skip=2)

create_df_surface_plot(sq_series_df, os.path.join(output_folder, "sq_series_furface.png"), skip=2,
                       level_limits=(-0.2, 2))
create_df_surface_plot(rdf_series_df, os.path.join(output_folder, "rdf_series_furface.png"), skip=2,
