...
scattering_intensity_param = pandas.read_csv(os.path.join(data_path, 'param_incoherent_scattering_intensities.csv'),
                                             index_col=0)

atomic_weights = pandas.read_csv(os.path.join(data_path, 'atomic_weights.csv'), index_col=0)
